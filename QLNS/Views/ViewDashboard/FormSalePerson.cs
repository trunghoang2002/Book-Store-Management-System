...
using QLNS.Views.ViewLogin;
using QLNS.Views.ViewManagerBill;
using QLNS.Views.ViewRevenue;
using QLNS.Views.ViewUser;

namespace QLNS.Views.ViewDashboard
{
    public partial class FormSalePerson : Form
    {
        ...
        private void ibtnOder_Click(object sender, EventArgs e)
        {
            ActivateButton(sender, colorBtn);
            OpenChildFrom(new FormBill());
        }

        private void ibtnManageO_Click(object sender, EventArgs e)
        {
            ActivateButton(sender, colorBtn);
