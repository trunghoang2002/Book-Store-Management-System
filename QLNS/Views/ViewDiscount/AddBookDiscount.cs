...
{
    public partial class AddBookDiscount : Form
    {
        public delegate void Mydel(int idBook);
        public Mydel d;
        public AddBookDiscount()
        {
            InitializeComponent();
        ...
        private void cBtnSelect_Click(object sender, EventArgs e)
        {
